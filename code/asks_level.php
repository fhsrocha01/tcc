...
$id = $_SESSION['id_user'];
$sql = "SELECT id_user, name  FROM users WHERE id_user=$id";
...
<!DOCTYPE html>
    ...
    <body class="login-content">
		...
		<span class="badge bgm-gray m-b-15">Passo 1 de 2</span>
		<br/>

            Olá <?php echo $row_user['name']; ?>, este é seu primeiro acesso. Defina seu nível de inglês, assim ficará mais fácil encontrar amigos para praticar.

			<div class="btn-group m-t-20">
				<button type="button" class="btn btn-primary btn-lg dropdown-toggle" data-toggle="dropdown">
					Meu nível de inglês é
					<span class="caret"></span>
				</button>
				<ul class="dropdown-menu" role="menu">
					<li class="f-20"><a href="dashboard/updates.php?user=<?php echo $row_user['id_user']; ?>&level=1">Iniciante</a></li>
					<li class="f-20"><a href="dashboard/updates.php?user=<?php echo $row_user['id_user']; ?>&level=2">Básico</a></li>
					<li class="f-20"><a href="dashboard/updates.php?user=<?php echo $row_user['id_user']; ?>&level=3">Intermediário</a></li>
					<li class="f-20"><a href="dashboard/updates.php?user=<?php echo $row_user['id_user']; ?>&level=4">Avançado</a></li>
					<li class="f-20"><a href="dashboard/updates.php?user=<?php echo $row_user['id_user']; ?>&level=5">Fluente</a></li>
				</ul>
			</div>
