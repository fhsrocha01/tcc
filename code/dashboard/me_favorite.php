...
$id = $_SESSION['id_user'];
$sql = "SELECT * FROM favorite WHERE id_favorite=$id ORDER BY id DESC";
...
<head>
  ...
  <title>Me favoritaram - We Learn</title>
      ...
      <div class="container">
        <div class="card">
          <ul class="tab-nav tn-justified">
            <li class="waves-effect"><a href="favorites.php">Meus favoritos</a></li>
            <li class="active waves-effect"><a href="me_favorite.php">Me favoritaram <span class="badge"><?php echo $totalRows_favorite; ?></span></a></li>
          </ul>
          ...
          <div class="card-body card-padding">
            ...
            <div class="contacts clearfix row">
              <?php if($totalRows_favorite!=0){
                do {
                  $me_favorite = $row_favorite['users_id_user'];
                  $sql = "SELECT id_user, name, photo FROM users WHERE id_user='$me_favorite'";
                  ...
                  <?php }
                    ...
                    <div class="jumbotron bgm-white text-center">
                      <p>Nenhuma pessoa te favoritou ainda.</p>
                    </div>
                    <?php }?>
